import 'package:fl_ecommerce/common/widgets/success_screen/success_screen.dart';
import 'package:fl_ecommerce/features/authentication/screens/login/login.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        // Padding to Give Default Equel Space on all sides in all screens
        child: Padding(
